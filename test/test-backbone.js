...
(function () {
    ...
    book.save({ok: 'ok'}).then(function () {
        console.log('SAVED');
    });

    serverStatus('up');

    Backbone.LocalCache.PendingOperations.executeAll();
    ...
    //             assert.notEqual(book.storageKey, book.url());
    //         }
    //     });
    ...
    // QUnit.asyncTest('model: fetch local', function (assert) {
    //     expect(4);
    //     localStorage.clear();
    //     reset();
